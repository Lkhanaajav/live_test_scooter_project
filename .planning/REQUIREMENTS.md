...
- [ ] **STRUCT-01**: Merge Closed-Loop chapter into System Design — 6 total chapters
...
- [ ] **EVAL-01**: Remove checkpoint benchmark table (Table 7) — replace with teacher-student comparison narrative
- [ ] **EVAL-02**: Add design iteration progression table (v1→v2→v3→v4 with key metrics at each stage)
- [ ] **EVAL-03**: Consolidate redundant runtime tables (merge current Tables 5+6 into one)
- [ ] **EVAL-04**: Add naive baseline discussion (raw mask center-following as conceptual baseline)
