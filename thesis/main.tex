...
This chapter extends the offline perception pipeline described in Chapter~\ref{ch:methodology} to a real-time closed-loop system capable of autonomous sidewalk navigation. We describe seven additions: (1)~a two-layer temporal mask stabilization scheme, (2)~a lightweight object-detection module for dynamic obstacle awareness, (3)~GPS-based waypoint navigation for global route following, (4)~precise steering-angle and speed computation, (5)~a serial command protocol for the scooter platform, (6)~temporal smoothing for heading and speed stability, and (7)~a live demonstration system that integrates all components.
